  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 space-y-6 sm:space-y-8 pb-24 sm:pb-12">
      ...
      <div className="space-y-2.5 text-center sm:text-left">
        ...
        <h1 className="text-2xl sm:text-5xl font-display font-extrabold text-white tracking-tight">
      ...
      {/* ========================================================================= */}
      {products.length === 0 ? (
        <div className="relative overflow-hidden rounded-3xl glass-panel-gold border border-gold-500/30 p-6 sm:p-16 text-center shadow-2xl bg-gradient-to-b from-obsidian-900/90 via-obsidian-950/95 to-obsidian-950">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            {/* Festive Icon / Badge */}
            <div className="w-16 h-16 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-gold-500/20 to-amber-500/10 border border-gold-500/40 flex items-center justify-center mx-auto shadow-glow-gold">
              <Sparkles className="w-8 h-8 sm:w-12 sm:h-12 text-gold-400 animate-pulse" />
            </div>
            ...
            <div className="space-y-3">
              ...
              <h2 className="text-xl sm:text-4xl font-display font-black text-white tracking-tight">
            ...
            {/* Highlights Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-2 text-xs text-slate-300 max-w-lg mx-auto">
        ...
        <>
          ...
          <div className="glass-panel-gold rounded-3xl p-4 sm:p-6 space-y-4 sm:space-y-5 border border-gold-500/25 shadow-glass">
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 sm:gap-4">
              <div className="relative flex-1 w-full">
                ...
                <input
                  ...
                  className="w-full bg-obsidian-950/90 border border-white/10 rounded-2xl pl-11 pr-10 py-3 text-xs sm:text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-gold-500 transition-colors min-h-[44px]"
                />
                {searchQuery && (
                  <button
                    onClick={() => setSearchQuery('')}
                    className="absolute right-3.5 top-3.5 p-1 rounded-md text-slate-400 hover:text-white min-h-[32px] min-w-[32px] flex items-center justify-center"
              ...
              <div className="flex items-center gap-3 w-full md:w-auto shrink-0">
                <div className="flex items-center gap-2 bg-obsidian-950 border border-white/10 rounded-2xl px-4 py-2.5 w-full md:w-auto min-h-[44px]">
                ...
                {isFiltering && (
                  <button
                    ...
                    className="px-4 py-2.5 rounded-2xl bg-obsidian-950 hover:bg-slate-900 border border-white/10 text-xs text-slate-300 hover:text-gold-300 flex items-center gap-1.5 whitespace-nowrap transition-colors min-h-[44px]"
                  >
                    <X className="w-3.5 h-3.5" />
                    <span>Reset</span>
                  </button>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="py-16 text-center glass-panel rounded-3xl p-8 space-y-4">
              ...
              <button
                onClick={handleResetFilters}
                className="px-6 py-3 rounded-xl bg-gold-500 text-obsidian-950 font-bold text-xs shadow-glow-gold min-h-[44px]"
              >
                Reset All Filters
              </button>
            </div>
